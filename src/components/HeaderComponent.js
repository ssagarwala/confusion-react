...
/* Long From <React.Fragment></ReactFragment>
Short From <></>
*/
constructor(props){
    super(props);
...
handleLogin(event){
    this.toggleModal();
    alert("Username" +this.username.value + "PAssworkd "+ this.password.value +
                ...
                <div className="container">
                  <div className="row row-header">
                        <div className="col-12 col-sm-6">
                            ...
                            <p> We take inspiration from the World
                                s best cuisines, and create a unique fusion experience. 
                                Our lipsmacking creations will tickle your clinary senses! </p>
